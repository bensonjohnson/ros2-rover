...
class SyntheticLidarNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('num_ranges', 720)       # Dense scan (0.5 degree)
        ...
        self.get_logger().info(f'Synthetic LIDAR: {freq}Hz, {self.num_ranges} ranges, {complexity} complexity')
    ...
    def publish_scan(self):
        ...
        scan_count = int((current_time - self.scan_time) * 20)  # Approximate scan number
