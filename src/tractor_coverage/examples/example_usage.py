...
def create_test_areas():
    ...
    rect_points = [(0, 0), (20, 0), (20, 15), (0, 15), (0, 0)]  # 20x15m rectangle
    ...
    # 2. L-shaped yard
    l_boundary = Polygon()
    l_points = [(0, 0), (15, 0), (15, 8), (8, 8), (8, 12), (0, 12), (0, 0)]
    for x, y in l_points:
        point = Point32()
        point.x = float(x)
        point.y = float(y)
    ...
    complex_points = [(0, 0), (25, 0), (25, 20), (20, 25), (5, 25), (0, 20), (0, 0)]
...
def create_obstacles():
    ...
    # Tree cluster
    tree_obstacle = []
    tree_points = [(8, 6), (10, 6), (10, 8), (8, 8), (8, 6)]  # 2x2m square obstacle
...
def demonstrate_ros_integration():
    ...
    try:
        ...
        print(
            "   Command: client.start_mowing_operation(boundary, tool_width=1.0, overlap=0.1)"
        )
        ...
        print(
            "   Command: client.start_spraying_operation(boundary, tool_width=1.5, overlap=0.05)"
        )

        print("\nTo actually execute operations:")
        print(
            "1. Launch the coverage system: ros2 launch tractor_coverage coverage_system.launch.py"
        )
        print(
            "2. Use the client in interactive mode: ros2 run tractor_coverage coverage_client"
        )
...
def print_usage_instructions():
    ...
    print(
        "   # Use CoverageClient.start_mowing_operation() or start_spraying_operation()"
    )
