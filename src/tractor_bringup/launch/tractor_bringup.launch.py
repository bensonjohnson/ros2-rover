...
def generate_launch_description():
    ...
    sensors_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            [
                PathJoinSubstitution(
                    [FindPackageShare("tractor_bringup"), "launch", "sensors.launch.py"]
                )
            ]
        ),
        launch_arguments={
    ...
    control_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            [
                PathJoinSubstitution(
                    [FindPackageShare("tractor_bringup"), "launch", "control.launch.py"]
                )
            ]
        ),
        launch_arguments={
    ...
    vision_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            [
                PathJoinSubstitution(
                    [FindPackageShare("tractor_bringup"), "launch", "vision.launch.py"]
                )
            ]
        ),
        launch_arguments={
    ...
    simulator_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            [
                PathJoinSubstitution(
                    [FindPackageShare("tractor_bringup"), "launch", "gazebo.launch.py"]
                )
            ]
        ),
