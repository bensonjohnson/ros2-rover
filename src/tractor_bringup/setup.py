...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "fly_brain_node.py = tractor_bringup.fly_brain_node:main",
            ...
            "rover_control = tractor_bringup.active_inference.rover_control:main",
            "hardstop_hold = tractor_bringup.hardstop_hold:main",
        ],
    },
)
