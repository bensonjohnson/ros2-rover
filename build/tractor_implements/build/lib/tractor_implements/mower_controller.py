...
class MowerController(Node):
    def __init__(self):
        ...
        GPIO.add_event_detect(
            self.blade_rpm_sensor_pin,
            GPIO.FALLING,
            callback=self.rpm_callback,
            bouncetime=10,
        )

        # Safety monitoring
        GPIO.add_event_detect(
            self.safety_stop_pin,
            GPIO.BOTH,
    ...
    def set_cut_height(self, height_mm):
        ...
        try:
            ...
            # 10-100mm -> 0-180 degrees
            servo_position = int((height_mm - 10) * 180 / 90)
            ...
            self.i2c_bus.write_byte_data(
                self.mower_height_i2c_addr, 0x00, servo_position
            )
