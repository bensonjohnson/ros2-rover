...
echo "  ✓ Direct point cloud safety monitoring with diagnostics"
...
echo "   Safety monitor: ros2 topic echo /safety_monitor_status"
echo "   Safety diagnostics: ros2 topic echo /diagnostics"
