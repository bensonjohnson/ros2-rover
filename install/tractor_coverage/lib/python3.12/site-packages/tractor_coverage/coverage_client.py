...
class CoverageClient(Node):
    ...
    def create_rectangular_boundary(self, center_x: float, center_y: float, 
    ...
    def create_circular_boundary(self, center_x: float, center_y: float, 
                                radius: float, num_points: int = 20) -> Polygon:
    ...
    def start_mowing_operation(self, boundary: Polygon, tool_width: float = 1.0, 
                              overlap: float = 0.1, include_perimeter: bool = True):
        ...
        self.get_logger().info(f'Started mowing operation with {len(boundary.points)} boundary points')
    
    def start_spraying_operation(self, boundary: Polygon, tool_width: float = 2.0, 
                                overlap: float = 0.05, include_perimeter: bool = False):
        ...
        self.get_logger().info(f'Started spraying operation with {len(boundary.points)} boundary points')
